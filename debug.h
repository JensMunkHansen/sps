...
#define debug_print(fmt, ...)                                                                      \
  __pragma(warning(push)) __pragma(warning(disable : 4127)) for (;;)                               \
  {                                                                                                \
    if (SPS_DEBUG)                                                                                 \
      fprintf(stderr, "%s:%s():%d: " fmt, __FILE__, __SPS_FUNCTION__, __LINE__, __VA_ARGS__);      \
  }                                                                                                \
  break;                                                                                           \
  }                                                                                                \
  __pragma(warning(pop))
...
#define debug_print(fmt, ...)                                                                      \
  __pragma(warning(push)) __pragma(warning(disable : 4127))                                        \
    __pragma(warning(disable : 6271)) for (;;)                                                     \
  {                                                                                                \
    if (SPS_DEBUG)                                                                                 \
    {                                                                                              \
      fprintf(stderr, "%s(): " fmt, __SPS_FUNCTION__, __VA_ARGS__);                                \
    }                                                                                              \
    break;                                                                                         \
  }                                                                                                \
  __pragma(warning(pop))
...
#define debug_cond_print(cond, fmt, ...)                                                           \
  ...
  {                                                                                                \
    if (cond)                                                                                      \
    {                                                                                              \
      fprintf(stdout, "%s(): " fmt, __SPS_FUNCTION__, __VA_ARGS__);                                \
    }                                                                                              \
    break;                                                                                         \
  }                                                                                                \
  __pragma(warning(pop))
...
#define debug_print(...)                                                                           \
  ...
  {                                                                                                \
    if (SPS_DEBUG)                                                                                 \
      fprintf(stderr, "%s:%d:%s(): " FIRST(__VA_ARGS__), __FILE__, __SPS_FUNCTION__,               \
...
#define debug_print(...)                                                                           \
  ...
  {                                                                                                \
    if (SPS_DEBUG)                                                                                 \
      fprintf(stderr, "%s(): " FIRST(__VA_ARGS__), __SPS_FUNCTION__ REST(__VA_ARGS__));            \
  } while (0)
...
#define debug_cond_print(cond, ...)                                                                \
  ...
  {                                                                                                \
    if (cond)                                                                                      \
      fprintf(stdout, "%s(): " FIRST(__VA_ARGS__), __SPS_FUNCTION__ REST(__VA_ARGS__));            \
  } while (0)
...
// Alternative way
// MULTI_LINE_MACRO_BEGIN if (DEBUG) fprintf(stderr, "%s(): " fmt, __SPS_FUNCTION__, __VA_ARGS__);
