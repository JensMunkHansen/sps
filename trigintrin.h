...
#else
  __m256d mask =
    _mm256_cmp_pd(x, _mm256_setzero_pd(), _CMP_LT_OQ); // TODO: Manage signals and ordering
...
STATIC_INLINE_BEGIN __m128 xacosf(__m128 d) {
  ...
  STATIC_INLINE_BEGIN __m128 _mm_cos_ps_fast(__m128 x)
  {
    ...
    x = _mm_add_ps(
      x, _mm_mul_ps(_mm_set1_ps(0.225f), _mm_mul_ps(x, _mm_sub_ps(_mm_fabs_ps(x), _m_one_ps))));
    return x;
  }
...
STATIC_INLINE_BEGIN void _mm_sin_cos_ps(__m128 d, __m128* s_, __m128* c_)
{
  ...
  r2x = _mm_castsi128_ps(
    _mm_xor_si128(_mm_and_si128(m, _mm_castps_si128(_mm_set1_ps(-0.0))), _mm_castps_si128(r2x)));

  m = _mm_cmpeq_epi32(
    _mm_and_si128(_mm_add_epi32(q, _mm_set1_epi32(1)), _mm_set1_epi32(2)), _mm_set1_epi32(2));
  r2y = _mm_castsi128_ps(
    _mm_xor_si128(_mm_and_si128(m, _mm_castps_si128(_mm_set1_ps(-0.0))), _mm_castps_si128(r2y)));
  ...
  *c_ = r2y;
  ...
  STATIC_INLINE_BEGIN __m128 _mm_sin_ps(__m128 d)
  {
    ...
    q = _mm_cvtps_epi32(_mm_mul_ps(d, _mm_set1_ps(static_cast<float>(M_1_PI))));
    u = _mm_cvtepi32_ps(q);
    ...
    d = _mm_castsi128_ps(_mm_xor_si128(
      _mm_and_si128(_mm_cmpeq_epi32(_mm_and_si128(q, _mm_set1_epi32(1)), _mm_set1_epi32(1)),
  ...
  STATIC_INLINE_BEGIN __m128 _mm_cos_ps(__m128 d)
  {
    ...
    q = _mm_cvtps_epi32(
      _mm_sub_ps(_mm_mul_ps(d, _mm_set1_ps(static_cast<float>(M_1_PI))), _mm_set1_ps(0.5f)));
    ...
    d = _mm_castsi128_ps(_mm_xor_si128(
      _mm_and_si128(_mm_cmpeq_epi32(_mm_and_si128(q, _mm_set1_epi32(2)), _mm_set1_epi32(0)),
        _mm_castps_si128(_mm_set1_ps(-0.0f))),
      _mm_castps_si128(d)));
...
#define _PI32_CONST(Name, Val)                                                                     \
  ...
  STATIC_INLINE_BEGIN __m128 _mm_exp_approx_ps(__m128 x)
  {
    ...
    retval = _mm_add_ps(_mm_add_ps(_mm_add_ps(_m_one_ps, x), _mm_mul_ps(part1, _m_half_ps)),
      _mm_mul_ps(part2, _m_sixth_ps));
    return retval;
  }
...
// TODO: Check properly for this function
  ...
  STATIC_INLINE_BEGIN float sin_fast(float a)
  {
    ...
    float c0[4] = { 0.0f, 0.5f, 1.0f, 0.0f };
    float c1[4] = { 0.25f, -9.0f, 0.75f, 0.159154943091f };
    float c2[4] = { 24.9808039603f, -24.9808039603f, -60.1458091736f, 60.1458091736f };
    float c3[4] = { 85.4537887573f, -85.4537887573f, -64.9393539429f, 64.9393539429f };
    float c4[4] = { 19.7392082214f, -19.7392082214f, -1.0f, 1.0f };
  ...
  */
  ...
  STATIC_INLINE_BEGIN __m128i ilogbp1(__m128 d)
  {
    ...
    __m128i q = _mm_and_si128(_mm_srli_epi32(_mm_castps_si128(d), 23), _mm_set1_epi32(0xff));
    q = _mm_sub_epi32(
      q, _mm_sel_epi32(_mm_set1_epi32(0x7e), _mm_set1_epi32(64 + 0x7e), _mm_castps_si128(m)));
    return q;
  }
  ...
  STATIC_INLINE_BEGIN __m128 _mm_cbrtf_ps(__m128 d)
  {
    ...
    q = _mm_sel_ps(q, _mm_set1_ps(1.2599210498948731647672106f),
      _mm_castsi128_ps(_mm_cmpeq_epi32(re, _mm_set1_epi32(1))));
    q = _mm_sel_ps(q, _mm_set1_ps(1.5874010519681994747517056f),
      _mm_castsi128_ps(_mm_cmpeq_epi32(re, _mm_set1_epi32(2))));
    ...
    y = _mm_mul_ps(
      _mm_sub_ps(y,
        _mm_mul_ps(_mm_mul_ps(_mm_set1_ps(2.0f / 3.0f), y), _mm_madd_ps(y, x, _mm_set1_ps(-1.0f)))),
      q);
