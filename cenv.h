...
#define SPS_RELAXED_MEMSET_END _Pragma("GCC diagnostic pop")
#else
#define SPS_RELAXED_MEMSET_BEGIN
#define SPS_RELAXED_MEMSET_END
#endif
...
#define SPS_DEPRECATED_FOR(since, replacement) [[deprecated("Since " #since "; use " #replacement)]]
#endif
...
#define SPS_ALIAS_FUNCTION(highLevelF, lowLevelF) const auto highLevelF = lowLevelF;
...
#define SPS_DEPRECATED_FOR(since, replacement) __declspec(deprecated)
#else
