...
#define SA_NOCLDSTOP                                                                               \
  1 /* Do not generate SIGCHLD when children                                                       \
stop */
#define SA_SIGINFO                                                                                 \
  2                           /* Invoke the signal catching function                               \
                             with three arguments instead of one                                   \
                          */
#define SA_RESTART 0x10000000 /* Restart syscall on signal return */
#define SA_ONSTACK                                                                                 \
  0x20000000 /* Call signal handler on alternate                                                   \
              signal stack provided by                                                             \
              sigaltstack(2). */
#define SA_NODEFER                                                                                 \
  0x40000000                     /* Don't automatically block the signal                           \
