...
private:
  ...
  static bool test(typename sps::enable_if<sizeof(C_T) ==
    sizeof(
      C_T(static_cast<C_AT_1>(*static_cast<typename sps::remove_reference<C_AT_1>::type*>(NULL)),
        ...
        static_cast<C_AT_4>(
          *static_cast<typename sps::remove_reference<C_AT_4>::type*>(NULL))))>::type*);
  ...
  static bool test(typename sps::enable_if<sizeof(C_T) ==
    sizeof(
      C_T(static_cast<C_AT_1>(*static_cast<typename sps::remove_reference<C_AT_1>::type*>(NULL)),
        static_cast<C_AT_2>(*static_cast<typename sps::remove_reference<C_AT_2>::type*>(NULL)),
        static_cast<C_AT_3>(
          *static_cast<typename sps::remove_reference<C_AT_3>::type*>(NULL))))>::type*);
...
private:
  ...
  static bool test(typename sps::enable_if<sizeof(C_T) ==
    sizeof(
      C_T(static_cast<C_AT_1>(*static_cast<typename sps::remove_reference<C_AT_1>::type*>(NULL)),
        static_cast<C_AT_2>(
          *static_cast<typename sps::remove_reference<C_AT_2>::type*>(NULL))))>::type*);
...
private:
  ...
  static bool test(typename sps::enable_if<sizeof(C_T) ==
    sizeof(C_T(static_cast<C_AT_1>(
      *static_cast<typename sps::remove_reference<C_AT_1>::type*>(NULL))))>::type*);
...
template <typename T, typename AT_1>
class is_constructible_impl_ptr<T, AT_1,
  typename enable_if<is_pointer<typename remove_reference<T>::type>::value, void>::type, void, void>
{
private:
  template <typename C_T>
...
template <class T>
  struct is_copy_constructible : std::is_constructible < T
...
template <class T>
  struct is_nothrow_copy_constructible : std::is_nothrow_constructible < T
  , typename std::add_lvalue_reference<typename std::add_const<T>::type>::type >>
{
};
} // namespace sps
