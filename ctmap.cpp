...
//#define intern_t(s)
//interned<ch(s,0),ch(s,1),ch(s,2),ch(s,3),ch(s,4),ch(s,5),ch(s,6),ch(s,7)>::type

#define intern_t(s)                                                                                \
  interned<ch(s, 0), ch(s, 1), ch(s, 2), ch(s, 3), ch(s, 4), ch(s, 5), ch(s, 6), ch(s, 7),         \
    ch(s, 8), ch(s, 9), ch(s, 10), ch(s, 11), ch(s, 12), ch(s, 13), ch(s, 14), ch(s, 15),          \
    ch(s, 16), ch(s, 17)>::type
...
struct singleton
{
  ...
  void do_action() { printf("singleton::do_action()\n"); }
};
...
template <typename K>
using get_singleton = map<K, singleton>;
