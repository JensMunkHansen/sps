// -*- compile-command: "clang++ -ggdb -o random_selection -std=c++0x -stdlib=libc++
...
struct random_selector
{
  ...
  // convenience function that works on anything with a sensible begin() and end(), and returns with
  // a ref to the value type
